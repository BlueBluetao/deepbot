...
export default function HumanoidSkeleton() {
  ...
  return (
    <svg viewBox="0 0 100 100" className="w-full h-full max-w-md mx-auto">
      ...
      {/* Head */}
      <ellipse cx="50" cy="10" rx="7" ry="8" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.4" />
      {/* Neck */}
      <rect x="48" y="18" width="4" height="4" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.3" />
      {/* Torso */}
      <path d="M38 22 L62 22 L60 50 L40 50 Z" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.4" />
      {/* Left arm */}
      <path d="M38 23 L25 28 L22 42 L26 42 L28 30 L38 26" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.4" />
      {/* Right arm */}
      <path d="M62 23 L75 28 L78 42 L74 42 L72 30 L62 26" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.4" />
      {/* Hips */}
      <path d="M40 50 L60 50 L58 56 L42 56 Z" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.4" />
      {/* Left leg */}
      <path d="M42 56 L38 78 L36 90 L42 90 L43 78 L46 56" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.4" />
      {/* Right leg */}
      <path d="M54 56 L57 78 L58 90 L64 90 L62 78 L58 56" fill="url(#bodyGrad)" stroke="#37306A" strokeWidth="0.4" />
